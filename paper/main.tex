...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{fig02_restatement.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig03_regime_nvda.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig04_regime_amd.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig05_regime_mrvl.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig06_regime_mu.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig07_fusion.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig08_state_means.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig09_ic_series.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{fig10_marginal.png}
...
All data derive from two public sources---Google Patents Public Data (\texttt{patents-\allowbreak public-\allowbreak data.\allowbreak patents.\allowbreak publications}) on BigQuery and the SEC EDGAR XBRL \texttt{companyfacts} API---and all code, queries, the firm registry, the merger-reattribution table, and the pre-registration deviation log are available in the replication repository. The universe definition, assignee-matching rules and exclusions, predecessor-CIK merges, and the QCOM amendment are recorded with timestamps preceding the predictive analysis.
